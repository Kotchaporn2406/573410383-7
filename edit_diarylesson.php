...
<?php
            ...
            $query = "SELECT * FROM diary_lesson WHERE id_lesson = '$request'";
                    ...
                    <form role="form" action="api_edit_diarytoday.php" method="post" >
                        <div class="box-body">
							...
							เรื่องราว :
                                ...
                                <textarea input type="textarea" class="form-control" id="story" name="story" required><?php echo $row["story_lesson"];?></textarea>
                            </div>
                        </div>
                        <!-- /.box-body -->
