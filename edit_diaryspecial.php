...
<?php
            ...
            $query = "SELECT * FROM diary_special_ex WHERE id_special_ex = '$request'";
                    ...
                    <form role="form" action="api_edit_diarytoday.php" method="post" >
                        <div class="box-body">
							...
							เรื่องราว :
                                ...
                                <textarea input type="textarea" class="form-control" id="story" name="story" required><?php echo $row["story_special_ex"];?></textarea>
                            </div>
                        </div>
                        <!-- /.box-body -->
						...
						<i class="fa fa-fw fa-save">
                            ...
                            <a class="btn btn-danger" href="page_special_ex.php" role="button">
