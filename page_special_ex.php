...
<body class="background">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="page_special_ex.php">ประสบการณ์พิเศษ</a>
          </li>
          <li class="nav-item">
  ...
  <div class="container" style="margin-bottom:1.5em">
    <h4>บันทึกประสบการณ์พิเศษณ์ต่างๆ ที่ประทับใจในชีวิตของคุณ</h4>
    <div class="card shadow">
      ...
      <div class="row">
        <div class="col-6">
          <a class="btn btn-success" href="type_special_ex.php" role="button">เพิ่มข้อมูล</a>
        </div>
        <div class="col-6">
...
<?php
            ...
            $query = "SELECT * FROM diary_special_ex WHERE id_special_ex";
            ...
            <div class="col-10  rounded shadow-dark-com com-bg-2">
                ...
                <hr>
                &nbsp; &nbsp;&nbsp;<?php echo $row["story_special_ex"];?><br>
                <hr>
                <div class="txt-sm">
                ...
                &nbsp; &nbsp;&nbsp;<a href="edit_diaryspecial.php?request=<?php echo $row['id_special_ex'];?>" class ="badge badge-warning"><h8 class="txt-white">แก้ไข</h8></a>&nbsp;<a href="api_del_diaryspecial.php?id_special_ex=<?php echo $row['id_special_ex'];?>" class ="del2 badge badge-danger"><h8 class="txt-white">ลบ</h8></a><br><br> 
                <?php
                }
                ?>
                </div>
